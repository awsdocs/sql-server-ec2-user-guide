# Best practices and recommendations for SQL Server clustering on Amazon EC2<a name="aws-sql-ec2-clustering"></a>
...
![\[Image NOT FOUND\]](http://docs.aws.amazon.com/sql-server-ec2/latest/userguide/images/failover_cluster_manager_1.png)
